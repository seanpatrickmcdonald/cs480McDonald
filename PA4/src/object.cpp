...
{
  ObjLoader objectLoader(objFilename);

  //Fill our data from the loader
  Vertices = objectLoader.Vertices;
  Indices = objectLoader.Indices;
...
void Object::Update(unsigned int dt)
{
  ...
  glm::mat4 ScaleMatrix = glm::scale(glm::vec3(3.0f, 3.0f, 3.0f));
